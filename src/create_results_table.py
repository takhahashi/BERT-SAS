...
def main(cfg: DictConfig):
    unames = ['reg_default', 'mul_reg_default', 'class_default', 'mul_class_default', 'mix_default', 'mul_mix_default', 'ordinal_reg_default', 'mul_ordinal_reg_default', 'class_trust', 'gp_default']#, 'class_mahalanobis_spectralnorm_loss_reg_metric', 'class_trust_spectralnorm_loss_reg_metric']
    #unames = ['class_default', 'class_trust', 'gp_default', 'reg_default', 'mix_default', 'class_mahalanobis_spectralnorm_loss_reg_metric']
    for uncert_metric in ['rcc', 'rpp', 'roc']:
        table = result_table(unames, uncert_metric, cfg.sas.question_id)
    model_names = ['reg', 'mul_reg', 'class', 'mul_class', 'mix', 'mul_mix', 'ordinal_reg', 'mul_ordinal_reg', 'gp']#, 'class_spectralnorm_loss_reg_metric']
