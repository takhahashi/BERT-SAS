...
def main(cfg: DictConfig):
    unames = ['reg_default', 'mul_reg_default', 'class_default', 'mul_class_default', 'ordinal_reg_default', 'mul_ordinal_reg_default', 'class_trust', 'gp_default']#, 'class_mahalanobis_spectralnorm_loss_reg_metric', 'class_trust_spectralnorm_loss_reg_metric']
    ...
    model_names = ['reg', 'mul_reg', 'class', 'mul_class', 'ordinal_reg', 'mul_ordinal_reg', 'gp']#, 'class_spectralnorm_loss_reg_metric']
